document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyFadeInToElements() {
    const selectors = [
      '.fade-in',
      '.animate-on-scroll',
      '.section-title',
    ...
    const mutationObserver = new MutationObserver(function (mutations) {
      mutations.forEach(function (mutation) {
        mutation.addedNodes.forEach(function (node) {
          ...
          const children = node.querySelectorAll('.' + OBSERVE_CLASS);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '604b4be8-721a-44f7-8a83-e5d442569fa3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '604b4be8-721a-44f7-8a83-e5d442569fa3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '604b4be8-721a-44f7-8a83-e5d442569fa3';
